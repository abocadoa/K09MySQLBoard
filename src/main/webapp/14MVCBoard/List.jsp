...
<body>
	...
	페이지번호를 출력한다. -->
    <h2>파일 첨부형 게시판-목록 보기(List)-현재 페이지:${map.pageNum }(전체:xxx)</h2>
    <form method="get">  
...
<c:choose>
	...
	<!-- 게시물을 저장하고 있는 boardLists컬렉션에 내용이 없다면 아래 부분을 출력한다. -->
        <tr>
	...
	<!-- 게시물이 있을때 컬렉션에 저장된 목록의 개수만큼 반복한다. -->
		...
		<!-- 
		가상번호 계산하기
		=>전체게시물개수-(((페이지번호-1)*페이지당 게시물수)+해당루프의 index)
		참고로 varStatus속성의 index는 0부터 시작한다.
		
			전체게시물의 개수가 5개이고 페이지당 2개씩만 출력한다면...
    ...
    <table border="1" width="90%">
        <tr align="center">
        	...
        	<td>
        		<!-- 
        		컨트롤러(서블릿)에서 클래스 호출을 통해 이미 페이지번호가 문자열로
